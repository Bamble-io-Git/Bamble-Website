  ...
  return createPortal(
    <>
      ...
      <div className="fixed top-[15%] left-[7%] md:left-[50%] z-50 font-tertiary">
        <div className="relative rounded-md sm:p-6 p-5 max-w-[95%] md:max-w-[85%] bg-white-primary font-tertiary">
          <div className="flex gap-2 sm:gap-4 items-start">
            <div>
              <p className="font-semibold mb-3 sm:mb-6 font-tertiary p-2">
                We will build a powerful intro in your resume for you!
              </p>

              <p className="mb-3 sm:mb-4 p-2">
              ...
              <div className="space-y-5 sm:space-y-6">
                {data.map((item) => (
                  <div
                    key={item.id}
                    className="flex gap-4 space-y-3 sm:space-y-6 items-center shadow-[0px_10px_30px_0px_rgba(0,0,0,0.1)] rounded-md  py-3 sm:py-6 px-5"
                  >
